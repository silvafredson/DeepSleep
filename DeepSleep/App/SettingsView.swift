                        ...
                        GroupBox(
                            ...
                            VStack {
                                ...
                                VStack {
                                    ...
                                    HStack {
                                        Text("White Noise vs. Pink Noise").fontWeight(.bold)
                                            .foregroundColor(Utils.SavedColors.fontColor)
                                        Spacer()
                                    ...
                                    Text("Like white noise, pink noise is a broadband sound containing components from across the sound spectrum. Pink noise contains sounds within each octave, but the power of its frequencies decreases by three decibels with each higher octave. As a result, pink noise sounds lower pitched than white noise. Researchers have compared the sound of pink noise to the noise produced by a waterfall. Studies have found that pink noise can enhance deep sleep in older adults and improve cognitive performance.")
                                } // VStack
                                Divider().padding(.vertical, 4)
                                
                                // MARK: - Sounds from Nature
                                HStack {
                                    Text("Sounds From Nature").fontWeight(.bold)
                                        .foregroundColor(Utils.SavedColors.fontColor)
                                    Spacer()
                                ...
                                VStack {
                                    Text("hearing rain, ocean waves, wind, and other natural sounds helps some people fall asleep.")
                                }
